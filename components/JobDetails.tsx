            ...
            return (
              <div key={bid.bidId} className="relative group">
                ...
                <div className="mt-2 px-4 py-2 bg-mc-stone/30 border-2 border-mc-stone">
                  ...
                  {/* Accept Bid Button - Show for job client */}
                  {(job.status === 'Posted' || job.status === 'POSTED' || job.status === 'Open') && (
                    <button 
                      ...
                      className="mt-3 w-full bg-mc-emerald text-white font-bold py-3 px-4 border-4 border-t-mc-ui-border-light border-l-mc-ui-border-light border-b-mc-emerald-dark border-r-mc-emerald-dark text-[10px] uppercase tracking-wider disabled:bg-mc-stone disabled:cursor-wait hover:brightness-110 transition-all flex items-center justify-center gap-2"
                    >
